package com.spring.cloud.point.service;
...
@Slf4j
@MapperScan("com.spring.cloud.point.service.mapper")
@EnableAsync
@EnableFeignClients
@EnableDiscoveryClient
@SpringBootApplication
public class SpringCloudPointServiceApplication {

	public static void main(String[] args) throws InterruptedException {
		ConfigurableApplicationContext context = SpringApplication.run(SpringCloudPointServiceApplication.class, args);
